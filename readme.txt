...
1. You can now disable the default function to load the status, and call the function directly. To disable the function simply untick the "Run Function in get_sidebar()" checkbox in the settings screen, you can then use the following code to get the status text: 
